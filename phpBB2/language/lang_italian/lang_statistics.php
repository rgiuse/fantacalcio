...
$lang['Auto_set_update_time'] = 'Determina ed imposta i tempi di aggiornamento per ogni modulo installato (ed attivato). Attenzione: può essere un\'operazione lunga.';
...
$lang['Not_allowed_to_install'] = 'Non sei abilitato ad installare questo modulo. Probabilmente perchè non hai installato il Mod necessario per utilizzare questo modulo. Contatta l\'autore del modulo de hai delle domande e se le Extra Info qui presenti non hanno significato per te.';
$lang['Wrong_stats_mod_version'] = 'Non sei abilitato ad installare questo modulo perchè lo Statistics Mod installato non è di una versione compatibile con quella richiesta dal modulo. Per utilizzare il modulo hai bisogno della Versione %s (o superiore) dello Statistics Mod.'; // replace %s with Version (2.1.3 for example)
$lang['Module_install_error'] = 'C\'è stato un qualche errore durante l\installazione di questo modulo. Sembra che alcuni comandi SQL non possono essere eseguiti, controlla i messagi di errore in alto.';

$lang['Preview_debug_info'] = 'Questo Modulo è stato generato in %f secondi: sono state eseguite %d queries.'; // Replace %f with seconds and %d with queries
