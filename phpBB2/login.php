...
if (!authent($HTTP_POST_VARS['username'],$HTTP_POST_VARS['password']) && (!isset($HTTP_POST_VARS['logout']) && !isset($HTTP_GET_VARS['logout'])))
{
			...
			else
			{
				if( md5($password) == $row['user_password'] && $row['user_active'] )
				{
					...
					if( $session_id )
					{
						...
						redirect(append_sid("$url?username=$user&password=$pass", true));
					}
					else
					{
