<?
	...
	if (checkStringMulti($camp)) 
	{
		...
		{
			$msg=urlencode("Non &egrave; stato possibile eliminare questo campionato : <b>$camp</b><br>in caso di ulteriori problemi contattate l' admin.");
			header("Location: $PATHNAME/pagine/messaggio.php?msg=$msg");
		}
	}
	else
